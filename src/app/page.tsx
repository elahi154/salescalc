...
export default function Home() {
  const appCards = [
    ...
    },
    {
      ...
      icon: <Presentation className="w-4 h-4 text-amber-300" />,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#070A12] text-white font-sans selection:bg-blue-600 selection:text-white pb-20">
      
      {/* 1. TOP APP BAR */}
      <header className="px-4 py-3 border-b border-slate-800/80 bg-[#070A12]/95 backdrop-blur-md sticky top-0 z-30">
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-blue-950/80 text-blue-300 border border-blue-800/80 text-[10px] font-bold">
      ...
      {/* 2. MAIN NATURAL TOP-FLOW CONTAINER (NO DEAD SPACING) */}
      <main className="flex-1 max-w-md w-full mx-auto px-4 pt-4 pb-2 space-y-3.5">
        ...
        {/* 2-COL CLEAN PROPORTIONATE TILES */}
        ...
        {/* Trust Badge */}
        <div className="text-center text-[10px] text-slate-400 font-medium flex items-center justify-center gap-1.5 pt-1">
      ...
      {/* 3. STICKY BOTTOM APP NAVIGATION */}
