      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-7 shadow-sm border border-slate-200/80 dark:border-slate-800 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs font-bold">
              <span className="text-slate-700 dark:text-slate-300 uppercase tracking-wider flex items-center gap-1.5">
                <IndianRupee className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Loan Principal
              </span>
              <span className="text-indigo-600 dark:text-indigo-400 font-extrabold">({formatINRCompact(loanAmount || 0)})</span>
            </div>

            <div className="flex items-center justify-between gap-3 bg-slate-50 dark:bg-slate-950 p-3 sm:p-4 rounded-2xl border border-slate-200 dark:border-slate-800 focus-within:border-indigo-500 transition-colors">
              <button
                type="button"
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-between text-xs font-bold">
              <span className="text-slate-700 dark:text-slate-300 uppercase tracking-wider flex items-center gap-1.5">
                <Percent className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Interest Rate
              </span>
              ...
              <div className="inline-flex p-1 bg-slate-100 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800">
                <button
                  ...
                  className={`px-3 py-1 text-xs font-bold rounded-lg transition-all ${
                    rateType === 'annual' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
                  Yearly
                </button>
                <button
                  ...
                  className={`px-3 py-1 text-xs font-bold rounded-lg transition-all ${
                    rateType === 'monthly' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
                  Monthly
                </button>
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-between text-xs font-bold">
              <span className="text-slate-700 dark:text-slate-300 uppercase tracking-wider flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Tenure Duration
              </span>
              ...
              <div className="inline-flex p-1 bg-slate-100 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800">
                <button
                  ...
                  className={`px-3 py-1 text-xs font-bold rounded-lg transition-all ${
                    tenureType === 'years' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
                  Years
                </button>
                <button
                  ...
                  className={`px-3 py-1 text-xs font-bold rounded-lg transition-all ${
                    tenureType === 'months' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
                  Months
                </button>
        ...
        {/* PAYMENT BREAKDOWN TABS & AMORTIZATION TABLE */}
        <PaymentBreakdown
